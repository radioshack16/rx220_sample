...
* NOTE       : THIS IS A TYPICAL EXAMPLE.
*
* Copyright (C) 2011(2010) Renesas Electronics Corporation and
...
struct st_sci0 {
	...
	union {
		unsigned char BYTE;
		struct {
			unsigned char RXDESEL:1;    // added according to p.731, HW manual, R01UH0292JJ0100 Rev.1.00, 20121115.
			unsigned char :1;
